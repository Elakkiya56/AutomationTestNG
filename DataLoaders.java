...
public class DataLoaders {
	...
	/*
	 * public static Object[][] excelDataLoader(String excelPath, String sheetName,
	 * Method name) throws IOException { ExcelObject testDataObj = new
	 * ExcelObject(excelPath); List<List<Object>> data =
	 * testDataObj.getExcelData(sheetName); testDataObj.closeWorkbook(); Object[][]
	 * objects = new Object[data.size() - 1][]; int i = 0; for (int ctr = 1; ctr <
	 * data.size(); ctr++) { if(data.get(ctr).contains(name.getName())) {
	 * List<Object> dataList = data.get(ctr); objects[i++] = dataList.toArray(new
	 * Object[dataList.size()]); } } return objects; }
	 * 
	 */
public static Object[][] excelDataLoader(String excelPath, String sheetName, Method name) throws IOException {
	...
	private static void getCommonData(String excelPath, Map<String, String> rowMap) throws IOException {
		ExcelObject testDataObj = new ExcelObject(excelPath);
		List<List<Object>> rows = testDataObj.getExcelData("Common");
		testDataObj.closeWorkbook();
		List<Object> headers = rows.get(0);
		int index = 1;
		Map<Integer, String> headerMap = new HashMap<Integer, String>();
	...
	public static Map<String, Map<String, String>> excelDataLoaderMulti(String excelPath, String sheetName, String methodName) throws IOException {
