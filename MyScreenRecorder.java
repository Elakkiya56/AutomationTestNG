...
public class MyScreenRecorder extends ScreenRecorder {
	...
	protected File createMovieFile(Format fileFormat) throws IOException {
		File movieFolder2 = new File(System.getProperty("user.dir") + File.separator+"Framework/Test_Reports/Videos");
		...
		return new File(movieFolder2,
				name + "-" + dateFormat.format(new Date()) + "." + Registry.getInstance().getExtension(fileFormat));

	}

	public static void startRecording(String methodName) throws Exception {
		File file = new File(System.getProperty("user.dir") + File.separator+"Framework/Test_Reports/Videos");
